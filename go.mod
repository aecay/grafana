...
// Loki doesn't support github.com/prometheus/common v0.21.0
...
replace github.com/grafana/grafana-plugin-sdk-go => github.com/grafana/grafana-plugin-sdk-go v0.92.1-0.20210427101032-097eafd38661
